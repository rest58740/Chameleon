...
void UBPC_LongInputControl_C::ExecuteUbergraph_BPC_LongInputControl(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BPC_LongInputControl_C", "ExecuteUbergraph_BPC_LongInputControl");

	Params::BPC_LongInputControl_C_ExecuteUbergraph_BPC_LongInputControl Parms{};
