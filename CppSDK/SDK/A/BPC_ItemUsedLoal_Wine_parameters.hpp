...
public:
	...
	class ABP_FirstPersonCharacter_LINK_C*        K2Node_DynamicCast_AsBP_First_Person_Character_LINK; // 0x0020(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class UBPC_ItemUsedLoal_Wine_C*>       CallFunc_K2_GetComponentsByClass_ReturnValue;      // 0x0088(0x0010)(ReferenceParm, ContainsInstancedReference)
	...
	class UBPC_ItemUsedLoal_Wine_C*               CallFunc_Array_Get_Item;                           // 0x00A0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_PerlinNoise1D_ReturnValue;                // 0x00A8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_PerlinNoise1D_ReturnValue_1;              // 0x00C4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UWidget*                                CallFunc_CustomAddWidget_CreatedeWidget;           // 0x00E8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_PerlinNoise1D_Value_ImplicitCast_1;       // 0x0114(0x0004)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_AddControllerPitchInput_Val_ImplicitCast; // 0x0120(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
