...
public:
	...
	TMulticastInlineDelegate<void(const class FString& Name)> OnPlayerNameReceived;                  // 0x0318(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(bool IsMicrophoneOn)> OnIsMicrophoneOnReceived;                    // 0x0328(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
